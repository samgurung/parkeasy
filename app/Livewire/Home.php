...
class Home extends Component
{
     ...
     *
     * @return Collection<int, array{status: string, rfid_id: ?string, vehicle_number: ?string, driver_name: ?string, vehicle_type: ?string, amount: ?float, time: Carbon, entry_id: int}>
     */
            ...
            ->flatMap(function (Entry $entry) {
                ...
                if ($entry->exit_time) {
                    $events->push([
                        ...
                        'vehicle_type' => $entry->vehicle_type ?? $entry->vehicle?->vehicle_type,
                        'amount' => $entry->amount,
